...
class Window():
    def __init__(self):
        ...
        menu_edit.add_command(label='Sort Alphabetically by row',
                              accelerator="Ctrl+B", command=self.cmd_sort_alphabetically_by_row)
        menu_edit.add_command(label='Sort Alphabetically by Word',
                        accelerator="Ctrl+S", command=self.cmd_sort_alphabetically_by_word)
        menu_edit.add_command(
        ...
        self.root.bind('<Control-s>', self.cmd_sort_alphabetically_by_row)
        self.root.bind('<Control-b>', self.cmd_sort_alphabetically_by_word)
    ...
    def cmd_sort_alphabetically_by_row(self, event=' '):
        text = list((self.notepad.get('1.0', END)).splitlines())
        text.sort()
        self.notepad.delete(0.0, END)
        for line in text:
    ...
    def cmd_sort_alphabetically_by_word(self, event=' '):
...
# TODO: Add Find Option
# TODO: Add Icon
# TODO: Add Print Option
# TODO: Add Text Alignment Option